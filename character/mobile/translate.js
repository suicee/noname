...
const translates = {
	...
	mbchoumang: "仇铓",
	mbchoumang_info: "每回合限一次，你使用【杀】指定唯一目标或成为【杀】的唯一目标后，可以选择一项：①令此【杀】伤害+1；②若此【杀】被【闪】抵消，你可以获得与你距离为1以内的一名其他角色区域里的一张牌；③背水：依次执行上述所有选项，然后弃置你与其装备栏里的武器牌。",
	mb_simazhou: "手杀司马伷",
	...
	pot_weiyan_prefix: "势",
	potzhongao: "忠傲",
	potzhongao_info: "使命技，①游戏开始时，你获得〖狂骨〗。②成功：你杀死一名角色，升级〖狂骨〗，回复X点体力并摸X张牌，体力值已满则改为摸等量张牌（X为你剩余的“壮誓”次数）。③失败：你进入濒死，或你未于出牌阶段开始时执行〖壮誓〗，失去〖壮誓〗并获得〖困奋〗，然后你回复1点体力并摸两张牌。",
	potzhuangshi: "壮誓",
	potzhuangshi_info: "出牌阶段开始时，你可以执行任意项：1.失去任意点体力，令你此阶段使用的前等量张牌不计入次数限制；2.弃置任意张手牌，令你此阶段使用的前等量张牌无距离限制且不可被响应。若均不执行，你增加1点体力上限并回复1点体力。",
	potyinzhan: "饮战",
	...
	mbjingtu: "净土",
	mbjingtu_info: "限定技，出牌阶段，你可选择一项：1.获得所有黑色“业”并对一名角色造成等量伤害；2.获得所有红色“业”，令一名角色增加1点体力上限并恢复等量体力；3.背水，两种颜色的“业”数量均大于1且相同。然后你失去〖浮图〗并获得〖佛宗〗。",
	mbjiebian: "劫辩",
	mbjiebian_info: "一名角色的出牌阶段结束时，若本阶段没有角色受到过伤害，你可与当前回合角色或体力值最低的角色拼点（你因此拼点时可以使用“业”进行拼点），赢的角色选择一项：1.对没赢的角色造成1点伤害；2.获得没赢的角色两张牌，然后令其恢复1点体力并摸一张牌。",
	mbfozong: "佛宗",
	...
	mbzhennan: "镇南",
	mbzhennan_info: "一名角色使用普通锦囊牌指定首个目标后，若此牌目标包含你且此牌目标书大于X（X为此牌使用者的体力值且至少为1），则你可以对一名角色造成1点伤害。",
